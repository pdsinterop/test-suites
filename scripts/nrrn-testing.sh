...
docker run --restart=always -d --network=testnet --name=revanc1.docker -v $REPO_ROOT/reva:/reva -e HOST=revanc1 pondersource/dev-stock-revad
...
docker run --restart=always -d --network=testnet --name=nc1.docker -v $REPO_ROOT/nc-sciencemesh:/var/www/html/apps/sciencemesh pondersource/dev-stock-nc1
docker run --restart=always -d --network=testnet --name=revanc2.docker -v $REPO_ROOT/reva:/reva -e HOST=revanc2 pondersource/dev-stock-revad
...
docker run --restart=always -d --network=testnet --name=nc2.docker -v $REPO_ROOT/nc-sciencemesh:/var/www/html/apps/sciencemesh pondersource/dev-stock-nc2
