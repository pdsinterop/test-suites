...
# docker exec -it maria1.docker mariadb -u root -peilohtho9oTahsuongeeTh7reedahPo1Ohwi3aek nextcloud -e "insert into oc_sciencemesh (apikey,sitename,siteurl,siteid,country,iopurl,numusers,numfiles,numstorage) values ('key','revanc1','https://nc1.docker','revanc1','NL','https://revanc1.docker',1,5,1);"
